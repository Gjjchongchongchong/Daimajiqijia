<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix"
          v-for="(detail,index) in orderInfo.detailArrayList" :key="detail.id">
          <li>
    ...
    <div class="sub clearFix">
      <!-- <router-link class="subBtn" @click="toPay">提交订单</router-link> -->
...
export default {
  ...
  methods: {
    // 修改默认地址
    changeDefault (index) {
      if (this.addressInfo[index].isDefault == 1) {
        return
      } else {
    ...
    async toPay () {
      ...
      try {
        await this.$store.dispatch('postSubmitTrade', { tradeNo, data })
  ...
  computed: {
    ...
    totalSkuNum () {
      let totalSkuNum = 0
      if (this.orderInfo.detailArrayList !== undefined) {
